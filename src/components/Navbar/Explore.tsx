...
const Explore = () => {
  return (
    <div className="relative w-[240px] flex items-center bg-[#f9f9f9] rounded-full pl-[8px] min-h-[36px] ">
      {/* Search Icon */}
      <svg 
      ...
      <input
        type="text"
        placeholder="Search"
        className="w-full text-sm border-none focus:outline-none focus:ring-0 bg-transparent pl-[8px]" 
      />     
    </div>
  );
};
